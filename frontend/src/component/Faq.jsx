        ...
        <section className="dark:bg-gray-100  dark:text-gray-800">
            <div className="container flex flex-col justify-center px-4 py-8 mx-auto md:p-8">
                ...
                <div className="space-y-4">
                    ...
                    <details className="w-full cursor-pointer border rounded-lg bg-[#e1ddd2]">
                        <summary className="px-4 py-6  font-bold focus:outline-none focus-visible:dark:ring-violet-600">
                            How do I choose the right size for a luxury watch?
                        </summary>
                        <p className="px-4 py-6 pt-0 ml-4 -mt-4 dark:text-gray-600 text-[#46402e]">
                    ...
                    <details className="w-full cursor-pointer border rounded-lg">
                        <summary className="px-4 py-6 font-bold focus:outline-none focus-visible:dark:ring-violet-600">
                    ...
                    <details className="w-full cursor-pointer border rounded-lg">
                        ...
                        <p className="px-4 py-6 pt-0 ml-4 -mt-4 text-[#bfbbaf] dark:text-gray-600">
