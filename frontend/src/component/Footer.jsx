    ...
    <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
            <div className="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
             <p className="text-base leading-relaxed text-white mt-7">Join our community of watch enthusiasts and stay updated on the latest trends</p>
            ...
            <div>
                ...
                <ul className="mt-6 space-y-4">
                    <li>
                        <a href="#" title="" className="flex text-base text-white transition-all duration-200 hover:text-gray-400 focus:text-gray-300"> Customer Support </a>
                    </li>
            ...
            <div className="col-span-2 md:col-span-1 lg:col-span-2 lg:pl-8">
                ...
                <form action="#" method="POST" className="mt-6">
                    ...
                    <button type="submit" className="inline-flex items-center justify-center px-6 py-4 mt-3 font-semibold text-gray-600 transition-all duration-200 bg-[#e2e2ba] rounded-md hover:bg-gray-100">Subscribe</button>
                </form>
            </div>
        </div>
