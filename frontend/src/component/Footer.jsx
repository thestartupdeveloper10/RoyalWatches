            ...
            <div className="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
             <p className="text-base leading-relaxed text-white mt-7">Join our community of watch enthusiasts and stay updated on the latest trends</p>
                ...
                <ul className="flex items-center space-x-3 mt-9">
                    <li>
                        <a href="#" title="" className="flex items-center justify-center text-white transition-all duration-200  rounded-full w-7 h-7 hover:bg-blue-600 focus:bg-blue-600">
